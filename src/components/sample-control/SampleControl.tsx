...
import { ArrowLeft, Database, ShieldCheck, History, Save, Eye, Loader2 } from 'lucide-react';
        ...
        {isAdminOrSupervisor ? (
          <Tabs defaultValue="verification" className="w-full">
              <TabsList className="grid w-full grid-cols-3">
                  <TabsTrigger value="verification"><ShieldCheck className="mr-2 h-4 w-4" />Verificación de Muestras</TabsTrigger>
                  <TabsTrigger value="admin"><Database className="mr-2 h-4 w-4" />Administración de Datos</TabsTrigger>
                  <TabsTrigger value="history"><History className="mr-2 h-4 w-4" />Historial de Verificaciones</TabsTrigger>
              </TabsList>
